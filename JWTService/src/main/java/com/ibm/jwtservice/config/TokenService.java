package com.ibm.jwtservice.config;
...
public class TokenService {
	...
	public String createToken(User usr) {
		Date tokenvalidity = new Date(new Date().getTime() + (tokenValidityInMinutes * 10000));
	
		return Jwts.builder().
				setSubject(usr.getLoginId())
				.claim("ROLE", usr.getRole())
				.claim("NAME", usr.getFirstName())
